...
GOOS=darwin GOARCH=arm64 go build -ldflags="-s -w" -o ${BUILD_DIR}/bark-darwin-arm64 ./cmd/bark

# macOS Intel
echo "Building for macOS AMD64 (Intel)..."
GOOS=darwin GOARCH=amd64 go build -ldflags="-s -w" -o ${BUILD_DIR}/bark-darwin-amd64 ./cmd/bark

# Linux x86-64
echo "Building for Linux AMD64..."
GOOS=linux GOARCH=amd64 go build -ldflags="-s -w" -o ${BUILD_DIR}/bark-linux-amd64 ./cmd/bark

# Linux ARM64 (Raspberry Pi, AWS Graviton, etc.)
echo "Building for Linux ARM64..."
GOOS=linux GOARCH=arm64 go build -ldflags="-s -w" -o ${BUILD_DIR}/bark-linux-arm64 ./cmd/bark

# Windows x86-64
echo "Building for Windows AMD64..."
GOOS=windows GOARCH=amd64 go build -ldflags="-s -w" -o ${BUILD_DIR}/bark-windows-amd64.exe ./cmd/bark
